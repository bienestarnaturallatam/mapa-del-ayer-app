...
export default function MapaDelAyer() {
  return (
    <div className="min-h-screen bg-[#FDFBF7] flex flex-col items-center justify-center p-6 text-center">
      <h1 className="text-4xl font-serif text-[#2C3E50] mb-4 italic tracking-tight">EL MAPA DEL AYER</h1>
      ...
      <div className="max-w-md bg-white p-8 rounded-3xl shadow-xl border border-gray-100">
        ...
        <button 
          ...
          className="w-full bg-[#2C3E50] text-white font-bold py-4 rounded-2xl hover:bg-opacity-90 transition shadow-lg active:scale-95"
        >
          COMENZAR MI VIAJE
        </button>
      </div>
      
      <p className="mt-8 text-xs text-gray-400 uppercase tracking-widest">Inspirado en Sanación Emocional</p>
    </div>
  );
}
